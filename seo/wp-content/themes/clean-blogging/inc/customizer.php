...
function clean_blogging_custom_css() {
    ?>
      <style type="text/css">
        ...
        a, .site-header a:hover, .main-navigation li a:hover, .entry-content a, .main-navigation li:hover .desktop-dropdownsymbol { color:<?php echo get_theme_mod( 'clean_blogging_accent_color', '#FF5722' ); ?>; }
        .comment-reply-link { background-color:<?php echo get_theme_mod( 'clean_blogging_accent_color', '#FF5722' ); ?>; }
        .pagination ul li a { border: 1px solid <?php echo get_theme_mod( 'clean_blogging_accent_color', '#FF5722' ); ?>; }


        a:hover, .entry-content a:hover, h2.entry-title a:hover, footer#colophon a:hover { color:<?php echo get_theme_mod( 'clean_blogging_accent_hover_color', '#FF5722' ); ?>; }
        .comment-reply-link:hover, .pagination ul li a:hover, .form-submit input:hover { background-color:<?php echo get_theme_mod( 'clean_blogging_accent_hover_color', '#FF5722' ); ?>; }
        .pagination ul li a:hover { border: 1px solid <?php echo get_theme_mod( 'clean_blogging_accent_color', '#FF5722' ); ?>; }

        .site-header, .main-navigation ul ul a { background-color:<?php echo get_theme_mod( 'clean_blogging_header_bg_color', '#fff' ); ?>; }

        .site-header a, .main-navigation .desktop-dropdownsymbol { color:<?php echo get_theme_mod( 'clean_blogging_header_text_color', '#222' ); ?>; }

        .main-navigation li li a:hover { color:<?php echo get_theme_mod( 'clean_blogging_header_text_hover_color', '#222' ); ?>; }

        footer#colophon { background-color:<?php echo get_theme_mod( 'clean_blogging_footerbg_color', '#ececec' ); ?>; }

        footer#colophon a, footer#colophon { color:<?php echo get_theme_mod( 'clean_blogging_footertext_color', '#404040' ); ?>; }
